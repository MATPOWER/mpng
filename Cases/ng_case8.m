...
mgc.node.info = [
    1   2	435.1130    650  406  0    0  100e3  100e3      0         2;
    2	1	406.1055    650  377  0    0  100e3  100e3      0         2;
    3	1	580.1507    653  508  0    0  100e3  100e3      0         2;
    4	1	565.6470	650  522  0    0  100e3  100e3      0         2;
    5	1	507.6319	650  464  0    0  100e3  100e3      0         2;
    6	1	551.1432	650  522  0    0  100e3  100e3      0         2;
    7	1	507.6319	650  464  0    0  100e3  100e3      12.2186   2;
    8	1	507.6319	650  464  0    0  100e3  100e3      26.4149   2;
    ];
...
mgc.comp = [
    ...
    3      4     2      0       0       0       1.15    4.8808  0.236   0   0.00025    0   80     0.005e3;
    ];

...
[f,df,~] = wey_approx(k_oij,p(from_o),p(to_o)); % Eval Weymouth equation approximation
...
[~,~,d2f] = wey_approx(k_oij,p(from_o),p(to_o)); % Eval Weymouth equation approximation
